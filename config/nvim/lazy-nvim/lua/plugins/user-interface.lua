return {
  { -- cool scrollbar
    ...
    init = function()
      ...
      hl(0, "CodewindowBackground", { fg = mocha.subtext0 })
      hl(0, "CodewindowBorder", { fg = mocha.overlay0 })
      hl(0, "CodewindowUnderline", { fg = mocha.overlay0 })
      hl(0, "CodewindowAddition", { fg = mocha.green })
      hl(0, "CodewindowDeletion", { fg = mocha.red })
    end,
    config = function()
